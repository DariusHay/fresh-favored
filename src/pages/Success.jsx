...
export default function Success() {
  ...
  return (
    <div className="px-4 py-16 sm:px-6 lg:px-10">
      <SEO title="Deposit Received | Fresh & Favored" description="Thank you for your Fresh & Favored booking deposit." />
      <div className="mx-auto max-w-2xl rounded-3xl bg-white p-8 shadow-soft">
        ...
        <h1 className="mt-2 font-display text-5xl text-brand-cocoa">Your deposit was received.</h1>
        <p className="mt-4 text-neutral-700">Fresh & Favored will follow up to confirm details, remaining balance, pickup, or event arrangements.</p>
